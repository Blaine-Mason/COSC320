...
class iterator
{
	public:
		...
		friend class myhash<T,HashFunc>;
		friend class const_iterator;
	...
	private:
		...
		iterator(myhash<T,HashFunc> *ht, int b,typename list<T>::iterator loc):
...
class const_iterator
{
	...
	private:
		...
		const myhash<T,HashFunc> *hashTable;
		...
		const_iterator(const myhash<T,HashFunc> *ht, int b,
